...
(custom-set-variables
 ...
 '(ibuffer-saved-filters (quote (("asterisk" ((not name . "^\\*[^\\*]+\\*$"))) ("default" ((not name . "^\\.newsticker-cache$") (not name . "^\\*\\(Process List\\|Help\\|vc\\|git-status\\|Completions\\|Messages\\|Compile-Log\\|compilation\\)\\*$"))) ("gnus" ((or (mode . message-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode)))) ("programming" ((or (mode . emacs-lisp-mode) (mode . cperl-mode) (mode . c-mode) (mode . java-mode) (mode . idl-mode) (mode . lisp-mode)))))))
 '(indent-tabs-mode nil)
 '(inhibit-startup-screen t)
 '(menu-bar-mode nil)
 '(message-send-mail-function (quote smtpmail-send-it))
 '(newsticker-url-list (quote (("Tagesschau" "http://www.tagesschau.de/newsticker.rdf" nil nil nil) ("Thomas Activity" "https://github.com/loardmalak.atom" nil nil nil))))
