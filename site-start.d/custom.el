...
(custom-set-variables
 ...
 '(browse-url-browser-function (quote browse-url-elinks))
 ...
 '(openwith-associations (quote (("\\.pdf\\'" . "DISPLAY=:0 zathura %s") ("\\.mp3\\'" . "DISPLAY=:0 mplayer %s") ("\\.\\(?:mpe?g\\|avi\\|flv\\|webm\\)\\'" . "DISPLAY=:0 mplayer -fs %s") ("\\.\\(?:lst\\)\\'" . "DISPLAY=:0 mplayer -fs -playlist %s") ("\\.\\(?:jp?g\\|png\\)\\'" . "DISPLAY=:0 feh %s"))))
 '(openwith-mode t)
