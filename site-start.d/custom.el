(custom-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "#042028" :foreground "#708183" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 90 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
 ...
 '(yas/field-highlight-face ((t (:background "DimGray" :foreground "black")))))
(custom-set-variables
 ...
 '(ibuffer-saved-filters (quote (("asterisk" ((not name . "^\\*[^\\*]+\\*.*$"))) ("default" ((not or (name . "^\\(.newsticker-cache\\|.bbdb\\|diary\\)$") (mode . rmail-mode)))) ("gnus" ((or (mode . message-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode)))) ("programming" ((or (mode . emacs-lisp-mode) (mode . cperl-mode) (mode . c-mode) (mode . java-mode) (mode . idl-mode) (mode . lisp-mode)))))))
